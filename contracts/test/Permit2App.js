...
//   const permit2AppAddress = "0x5FbDB2315678afecb367f032d93F642f64180aa3"; // Your deployed Permit2App address here.
//   const permit2AppContract = new ethers.Contract(
//     permit2AppAddress,
//     permit2AppABI,
//     signer
//   );
...
//           // type(uint160).max
//           expiration: calculateEndTime(30 * 24 * 60 * 60 * 1000),
//           // 30 days
//           nonce: currentNonce,
//           token: tokenAddress,
//         },
//         sigDeadline: calculateEndTime(30 * 60 * 1000),
//         spender: permit2AppAddress, // 30 minutes
//       };
...
//       const tx = await permit2AppContract.allowanceTransferWithPermit(
//         permitSingle,
//         signature,
//         amount
//       );
...
//       // Call our function that uses permit2 to `transferFrom()` to our contract.
//       const tx = await permit2AppContract.allowanceTransferWithoutPermit(
//         tokenAddress,
//         amount
//       );
...
//       const tx = await permit2AppContract.signatureTransfer(
//         tokenAddress,
//         amount,
//         nonce,
//         deadline,
...
//       // create witness
//       const witness = {
//         // must match structs data
//         witness: { user: user },

//         // type name must match the struct name we created in Permit2App
//         witnessType: { Witness: [{ name: "user", type: "address" }] },

//         witnessTypeName: "Witness", // witness' value
//       };
...
//       const tx = await permit2AppContract.signatureTransferWithWitness(
//         tokenAddress,
//         amount,
//         nonce,
//         deadline,
